...
<h2>✅ Документация</h2>
<ul>
  <li>Swagger UI / OpenAPI — <a href="https://barahlushik.github.io/Bank_REST/#/" target="_blank">Swagger Documentation</a></li>
</ul>
<h2>🚀 Инструкция по запуску</h2>
<ol>
  <li>Скопируйте `.env.example` в `.env` и подставьте свои данные для БД и JWT:
    <pre>
cp .env.example .env
    </pre>
  </li>
  <li>Запустите контейнеры через Docker Compose:
    <pre>
